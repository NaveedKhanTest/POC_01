...
namespace AzureWebApp.Services
{
    ...
    internal class RedisCache : IRedisCache
    {
        ...
        protected static readonly Lazy<ConnectionMultiplexer> LazyConnection = new Lazy<ConnectionMultiplexer>(() =>
        {
            ...
            var CacheSyncTimeout = Convert.ToInt32(ConfigurationManager.GetAppSettings("CacheSyncTimeout") );
            var CacheConnectTimeout = Convert.ToInt32(ConfigurationManager.GetAppSettings("CacheConnectTimeout"));
